...
def definir_jogadores(modo):
    ...
    if modo in [1, 2]:
        jogadores[1][0] = input("Defina o nome do jogador 1: ").strip()

        # Condição: se o modo é igual a 2, defini o nome do jogador 2 como "Computador"
        jogadores[2][0] = input("Defina o nome do jogador 2: ").strip() if modo == 2 else "Computador"
    else:
...
# Agradecimentos
print("\n Obrigado por jogar!")
print("\n Desenvolvido por: Líbia Silveira, Pedro Fonseca e Sérgio Calazans.\n")